...
TASK-0232 through TASK-0238 were created with `ackit task` before implementation. TASK-0232 completed decisions, TASK-0233 expanded resource evidence, TASK-0234 selected source base `b1604ae1e73017521d28e5a83f328bb1347406b6`, TASK-0235 refreshed the conditional freeze, TASK-0236 prepared the final-HEAD alpha4/alpha3 hosted input without dispatch, and TASK-0237 synchronized current documentation/handoff sources. TASK-0238's complete local suite passed with 430/430 tests and all required gates/hygiene checks. No version/publication was selected; later commits remain docs/evidence/governance-only. Create the closeout commit, push the complete chain once, and wait for `ci`, `cross-platform-smoke`, and `cross-platform-source-smoke` through the prescribed single blocking sequence. Stop at manual hosted RC workflow dispatch; do not mutate versions, packages, tags, releases, workflows, repository/security/collaborator settings, secrets, advisories, or recovery state.
