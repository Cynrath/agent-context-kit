...
- TASK-0177 is implemented locally: `ackit hooks` now supports Anthropic and Continue targets, dry-run preview with content lengths, lowercase `anthropic` target parsing, and compatibility for existing Codex/Claude Git hook behavior. Local validation reached 276/276 tests green; TASK-0178 MCP transport prototype step 1 is next.
