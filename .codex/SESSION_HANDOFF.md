...
- Current task is TASK-0218 alpha4 NuGet README rendering release prep. TASK-0217 (Windows Unicode temp directory fix) completed and pushed at `840c08f`. TASK-0210 through TASK-0216 are complete. No immediate release task is active; alpha4 is prepared locally, not published.
