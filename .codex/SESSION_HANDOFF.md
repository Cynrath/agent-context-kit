...
## Current Task
- PROJECT-CONTROL-0110 is now active for TASK-0188 through TASK-0196. Normal commits/pushes are allowed after local validation; force/history/tag movement/version reuse/API-key publication remain prohibited.
