...
- TASK-0200 is the current docs-only README/current-source CLI surface parity task. It must not change source code, package metadata, release status, tags, GitHub Releases, NuGet publication, workflows, security settings, owner/recovery state, or RB-003/RB-008 status.
