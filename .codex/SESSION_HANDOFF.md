...
## Current Task
- PROJECT-CONTROL-0110 is closed at TASK-0196 (2026-06-19) with cumulative suite 428/428 green and the final pushed HEAD at `b073c3d`. Normal commits/pushes remain allowed for explicit handoff docs and audits; force/history/tag movement/version reuse/API-key publication remain prohibited. TASK-0202 makes `0.2.0-alpha.3` release-preparation eligible by closing RB-003/RB-008 from maintainer evidence. TASK-0203 is active release preparation only: local metadata/package validation may proceed, but publication remains unapproved.
...
- TASK-0203 plan commit `da51d4d` opens local `0.2.0-alpha.3` release preparation. Scope is limited to package metadata, CLI runtime version, source-package smoke version parity, README/release-prep docs, local package validation, and installed-tool smoke. Hosted RC evidence, release GO, tag, GitHub Release, NuGet publish, release workflow dispatch, release-candidate dispatch, owner/account/recovery mutation, repository secret creation, branch ruleset mutation, security advisory, and destructive NuGet actions remain unauthorized.
