...
AgentContextKit published `0.2.0-alpha.3` package and current source can write scanner findings as SARIF 2.1.0 for CI review and future GitHub Code Scanning workflows.
...
- use the published `0.2.0-alpha.3` package; or
