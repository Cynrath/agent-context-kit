...
| Bad-package recovery | PARTIAL MAINTAINER on 2026-06-14 | `docs/PACKAGE_RECOVERY.md` accepts immutable history, activation thresholds, successor/unlist/deprecate flow, communication, and review cadence; `Cynrath` is decision owner | Verify NuGet execution authority for `Cyranth` and assign backup recovery ownership | P1 blocker remains |
