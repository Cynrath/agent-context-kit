...
| MD-003 | RB-003 notifications | Partial | Primary assigned; backup and coverage evidence pending | Private reports need continuity beyond one account | Cynrath primary; backup unassigned | `docs/SECURITY_NOTIFICATION_OWNERSHIP.md`; TASK-0198 confirms no second verified human owner or notification coverage record | Repository | Before next RC | No test advisory created; no security setting changed |
