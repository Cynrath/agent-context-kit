...
| MD-013 | V100-02 CLI contract | Decision recorded / open | Shipped/documented alpha4 surface is the V100 target contract preserved by candidate `1.0.0-rc.1` | Stabilizes machine-readable consumers without falsely freezing localized prose byte-for-byte | Cynrath | `docs/V100_MAINTAINER_DECISION_PACKET.md`; TASK-0232; TASK-0239 | Source candidate `1.0.0-rc.1` and published predecessor `0.2.0-alpha.4` | TASK-0241 final-candidate acceptance | No remote action |
...
| MD-015 | V100-08 support lifecycle | Decision recorded / open | .NET 10, Windows/Ubuntu/macOS, latest-pre-release fixes, predecessor rollback evidence, documented unsupported surfaces | Establishes the current support baseline while retaining final-RC hosted confirmation | Cynrath | `docs/SUPPORT_LIFECYCLE.md`; decision packet | V100 target contract | Final-RC three-OS rerun | No remote action |
| MD-016 | V100-09 supply chain | Decision recorded / open | OIDC/immutability/alignment/inspection/digest/signature/assets/upgrade/recovery baseline; signing/SBOM accepted risks preserved | Recovery ownership is complete; provenance can only be proven on the next authorized publish path | Cynrath | `docs/V100_MAINTAINER_DECISION_PACKET.md`; `docs/SUPPLY_CHAIN_DECISIONS.md`; `docs/PACKAGE_RECOVERY.md` | V100 target contract | Hosted provenance evidence; accepted-risk review by 2026-09-30 | No publish/attestation/recovery action |
| MD-017 | V100 candidate selection | Prepared / open | Select `1.0.0-rc.1` with published predecessor `0.2.0-alpha.4` | A real successor version avoids immutable alpha4 reuse and enables exact hosted validation | Cynrath release maintainer | TASK-0239; `docs/V100_RC1_RELEASE_PLAN.md`; exact alpha4 generated-config fixture | Exact TASK-0239 candidate commit after creation | TASK-0240 hosted evidence and TASK-0241 acceptance | Candidate preparation only; no publication/tag/release/provenance action |
