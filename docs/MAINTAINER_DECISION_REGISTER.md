...
| MD-019 | TASK-0242 publication | Authorized / not yet dispatched | Publish `1.0.0-rc.1` exactly once through existing OIDC `release.yml`; create exact tag/prerelease/assets/provenance and verify post-publish state | Explicit user authorization on 2026-07-11 after TASK-0241 acceptance and green final CI | Cynrath release maintainer | User instruction; TASK-0242; TASK-0239/0240/0241 evidence | One `release.yml` publish dispatch for `1.0.0-rc.1` only | Ends after single dispatch; no recovery/second dispatch | OIDC publish/tag/release/attestation authorized; no manual upload, version reuse, tag move, recovery, rerun, or force push |
