...
| MD-013 | V100-02 CLI contract | Decision recorded / open | Current shipped/documented surface is the V100 target contract | Stabilizes machine-readable consumers without falsely freezing localized prose byte-for-byte | Cynrath | `docs/V100_MAINTAINER_DECISION_PACKET.md`; TASK-0232 | Current source and published `0.2.0-alpha.4` surface | Final-candidate acceptance | No remote action |
