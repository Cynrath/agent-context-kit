...
| 3 | TASK-0234 final-candidate local source selection and preparation | CURRENT | Select the exact last source-impacting local commit as evidence base | TASK-0233 | SHA/path review and candidate input validation | No version bump or publish |
