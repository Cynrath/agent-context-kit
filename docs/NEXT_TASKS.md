...
| 14 | TASK-0252 existing exact tag recovery workflow adaptation | COMPLETED LOCALLY / PENDING PUSH AND CI | Exact existing tag accepted; every recovery tag mutation removed; fail-closed release/asset/attestation checks added | Owner-created exact tag plus explicit authorization | Focused recovery tests and full local suite PASS (431/431) | First normal push pending; no release dispatch |
