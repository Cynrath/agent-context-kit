...
| 5 | TASK-0236 hosted RC evidence input preparation | CURRENT | Prepare exact post-push alpha4/alpha3 dispatch inputs and evidence schema | TASK-0235 | Workflow/input static tests | Manual workflow dispatch is not executed |
