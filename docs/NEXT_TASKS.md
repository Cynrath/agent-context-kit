...
| 4 | TASK-0235 final-candidate local contract freeze preparation | CURRENT | Refresh the conditional freeze against the selected base and target contract | TASK-0234 | CLI/config/JSON/localization/V100 doc gates | Final acceptance remains pending |
