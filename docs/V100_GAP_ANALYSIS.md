...
| V100-09 | P1 | Release supply-chain policy still lacks hosted provenance evidence. | TASK-0252 verified the owner-created exact tag without mutation and passed three-OS CI. TASK-0253 run `29345313517` passed all immutable gates, but `gh release create` returned HTTP 403. One audit confirmed NuGet/artifact/tag unchanged and prerelease/assets/two attestations absent; the recovery matrix was skipped. | Release + Maintainer | Preserve every partial history. The TASK-0253 failure boundary prohibits settings changes, retry, rerun, redispatch, or manual completion; TASK-0254 was not executed. | Yes | Yes, but the TASK-0253 budget is consumed | FOURTH_RECOVERY_ATTEMPT_STOPPED / RELEASE_CREATE_403 / REMOTE_STATE_UNCHANGED / OPEN |
