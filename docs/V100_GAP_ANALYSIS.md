...
| V100-09 | P1 | Release supply-chain policy still lacks hosted provenance evidence. | TASK-0242 run `29131335084` published NuGet RC1 through OIDC but timed out verifying propagation before tag/release/provenance; one-time audit verified repository signature/commit/global install and confirmed tag/release/attestation absent. | Release + Maintainer | Execute the newly authorized exact-existing-package TASK-0243/0244 recovery without any second NuGet push; require exact tag/release assets, both attestations, and three-OS install evidence. | Yes | Yes, exactly one bounded recovery dispatch | RECOVERY_AUTHORIZED / TASK-0243_IN_PROGRESS / OPEN_PENDING_EXACT_RELEASE_AND_PROVENANCE |
...
Open P0 gaps: 0. V100-06 remains closed by TASK-0232; TASK-0241 closes V100-01 through V100-05 from exact local/hosted evidence and final acceptance. V100-09 remains open while TASK-0243/0244 implement and execute the separately authorized exact-existing-package recovery.
