...
| V100-09 | P1 | Release supply-chain policy still lacks hosted provenance evidence and complete recovery ownership. | TASK-0132 bounded-defers author signing/SBOM through 2026-09-30 and adds future-release GitHub provenance; destructive recovery authority and backup ownership remain. | Release + Maintainer | Obtain provenance evidence on the next release and complete recovery/backup ownership. | Yes | Yes, for provenance publication or recovery actions |
