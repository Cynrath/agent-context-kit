...
### `ackit config-check`
Validates `.ackit/config.yml` without changing it. This command is included in the published `1.0.0-rc.1` package.
...
- `ackit sarif` is available in NuGet `1.0.0-rc.1`.
