...
| 8 | Implemented / local pass / ready to push | TASK-0246 cross-platform recovery safety gate host fix | Use `pwsh`, preserve pre-mutation gates, and polish all README sources | New explicit authorization | Script/workflow tests, README/docs/task/handoff files | 431/431 local and release gates PASS; hosted CI pending | One normal push; no dispatch/release mutation |
