...
| BW3 | In progress / local pass | TASK-0260 Optimize CLI and outputs | Console/JSON/Markdown/SARIF/offline HTML, schemas, localization, exits | TASK-0259 completed/hosted PASS | 10/10 focused; 454/454 full; build 0/0; five-format no-mutation smoke; hosted pending push | Normal validated push only |
