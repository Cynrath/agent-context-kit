...
| BW4 | In progress / local pass | TASK-0261 non-destructive proposal and demo | Explicit-path proposal, mappings, unresolved decisions, synthetic demo | TASK-0260 completed/hosted PASS | 463/463 full; build 0/0; proposal/demo/CLI focus 15/15; all local gates and no-mutation smoke PASS | Normal validated push only |
