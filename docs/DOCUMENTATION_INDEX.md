...
- `docs/DEMO_SCENARIOS.md`: guided published package, ACKit Optimize, source, sample, Web UI, report, and SARIF demos.
...
- `docs/V100_RC1_RELEASE_PLAN.md`: selected `1.0.0-rc.1` candidate scope, compatibility, risks, rollback, publication prerequisites, and explicit authorization boundary.
- `docs/RELEASE_BODY_V100_RC1.md`: unpublished draft GitHub prerelease body for the selected candidate.
...
- `tests/fixtures/upgrade/v0.2.0-alpha.4-config.yml`: exact sanitized config generated by the published alpha4 predecessor for RC upgrade evidence.
...
- `docs/RELEASE_BODY_V100_RC1.md`: draft-only `1.0.0-rc.1` body; publication requires separate TASK-0242 authorization.
