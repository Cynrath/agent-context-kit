...
| `ackit checkpoint show <id> [cpId] \| validate <id> \| export <id> [--out file] [--format md\|json] \| import <file>` | checkpoint inspection, staleness validation, handoff pack (md = v1) / verification-bound portable handoff (json = `ackit.handoff.v2`), read-only handoff import (`ackit checkpoint import <file>`) with stale refusal |
