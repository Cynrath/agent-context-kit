...
| `ackit sync [--dry-run] [--check] [--force]` | reconcile ACKit-owned managed assets (instructions + skills) after upgrades; content-driven, never version-driven (shipped; see CHANGELOG) |
