...
Require-Text $maintainerDecision "Publication authorized: No" "Maintainer publication boundary"
...
Require-Text $v100DecisionPacket "CLI And Machine-Readable Contract" "V100-02 contract decision"
Require-Text $v100DecisionPacket "DONE_CRITERIA_FRESHLY_VERIFIED" "V100-06 closure evidence"
Require-Text $v100DecisionPacket "Runtime And Support Lifecycle" "V100-08 support decision"
Require-Text $v100DecisionPacket "Supply Chain And Recovery" "V100-09 provenance decision"
