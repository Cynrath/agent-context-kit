...
| RC1 partial state | NuGet `1.0.0-rc.1` exists and installs; TASK-0244 and TASK-0247 recovery runs stopped before mutation, so tag, GitHub prerelease, and provenance remain absent |
